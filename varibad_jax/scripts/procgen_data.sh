...
for i in "${!download_tasks[@]}"; do
    ...
    gdown --continue --output /scr/aliang80/varibad_jax/varibad_jax/datasets/procgen/expert_data/$task.zip $file_id
    unzip -q -o /scr/aliang80/varibad_jax/varibad_jax/datasets/procgen/expert_data/$task.zip -d /scr/aliang80/varibad_jax/varibad_jax/datasets/procgen/expert_data/ && rm /scr/aliang80/varibad_jax/varibad_jax/datasets/procgen/expert_data/$task.zip
done